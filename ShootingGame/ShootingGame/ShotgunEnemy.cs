...
namespace ShootingGame
{
    ...
    {
        public ShotgunEnemy(int x, int y, int level) : base(x, y, /*r=*/20, /*speed=*/level + 5, Images.SHOTGUN_ENEMY_IMAGE, /*LV=*/level, /*hp=*/3, /*bulletRadius=*/Bullet.RADIUS_FOR_MEDIUS, 70)
        {
        }
